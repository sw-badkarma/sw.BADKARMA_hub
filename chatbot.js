// ==========================================
// LOGICA CHATBOT-ULUI KARMA AI (Ediția cu Diacritice & Online + Buton Help Lângă Online)
// ==========================================
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function setupOnlineIndicator() {
        ...
        // Partea stângă (Grupul cu ONLINE și butonul Help scris practic)
        ...
        // Butonul "practic" scris lângă cel cu ONLINE
    ...
    function getBotResponse(input) {
        // Aici păstrăm logica ta și adăugăm normalizarea diacriticelor
        ...
        if (botState.awaitingContext === 'awaiting_draw_region') {
            ...
            // Dacă utilizatorul scrie altceva în loc să dea regiunea (schimbă subiectul), anulăm starea veche
            if (!cleanText.includes('ro') && !cleanText.includes('romania') && !cleanText.includes('europa') && 
                ...
                botState.awaitingContext = null; // Ieșim din starea de Lucky Draw
                // Continuă mai jos spre căutarea normală în dicționar
            } else {
                // Dacă a scris corect o regiune, calculăm costul și resetăm starea
